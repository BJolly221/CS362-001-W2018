...
public class TimeTableRandomTest {
	   ...
	   /**
	     ...
	     */
		 @Test
		  public void testDeletAppt()  throws Throwable  {
		...
		//			System.out.println(" Seed:"+randomseed );
				 ...
				 for (int i = 0; i < NUM_TESTS; i++) {
					 int TstartHour=ValuesGenerator.getRandomIntBetween(random,1, 29); 
					 ...
					 if(Tempappt.getValid() == false) {
						 assertEquals(null,timeTable.deleteAppt(calDay.getAppts(), Tempappt) );
						 falsetest++;
						 }
					 else {
						 //Unable to get this to work for some reason?
						 //assertEquals(calDay.getSizeAppts(), timeTable.deleteAppt(calDay.getAppts(), Tempappt).size());
						 truetest++; 
						}
